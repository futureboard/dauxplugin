/*
 * daux_abi.cpp - ABI version helpers and result-code formatting.
 *
 * Part of the host-side C++ helper library (daux_core). Not part of the plugin
 * ABI itself.
 */
...
bool abi_compatible(uint32_t plugin_abi_version) noexcept {
    /* Major version must match exactly; minor/patch are forward compatible. */
